...
//    public static final String POPUP_ID = "POPUP_ID";   // used to send popupId to a fragment
    ...
    public static final String [][] nodeDetails = new String[][] {
      ...
      new String[] {(String.valueOf(VICTORY_NODE)), "Trapistan has been freed from Space Fascist control, and Governor-Professor Notevil has been brought to Democratic justice.\n\nOnce again, the galaxy is in Macho Squad's debt.", "BuffEagle", "NULL"},
      new String[] {(String.valueOf(PARTIAL_VICTORY_NODE)), "Trapistan is no longer under the control of Space Fascists, and Governor-Professor Notevil has been vaporized with acceptable losses.\n\nOnce again, the galaxy is in Macho Squad's debt.", "BuffEagle", "NULL"},
      new String[] {"1", "The pod rattles around you as it slices through the atmosphere, your cybernetics clacking against the steel drop chair.  You're getting too old for this, but Democracy needs you one more time.  Governor-Professor Notevil of the planet Trapistan has been captured, and only the raw machismo and untamed skill of &PlayerCharacter& and Macho Squad can save him.\n\nTurbulence shakes your vehicle, and through the structurally unnecessary window you see bursts of Anti-Aircraft fire streaking past.  The equipment pod is hit first, tearing apart as it screams towards the ground, but there is nothing to do but continue your pull-up routine as fire rakes your squad’s drop pods. You see Duke Ramierez`s pod catch flame and veer off course just before your landing rockets fire.  He was just two space days from retirement.\n\nThe landing restraints dig against your bulging muscles as you crash to a stop.  Pulling the straps free, you do one final pull-up to finish your set.  ``One-hundred-thousand.``  Stepping free from the steel coffin you cast your gaze around.  You`ve landed in an open field surrounded by wheat.  In the distance you can see smoke rising from where you can assume Hawkins` pod came down.  Around you is the debris from the other pods.  Would you like to:", "PodsLanding", "NULL"},
      new String[] {"3", "With dawn breaking, you set your course away from the fields.  You`re here to rescue Governor-Professor Notevil, and you`ll be damned if the complete obliteration of your team is going to slow you down.  Shouldering the few items you have left, you head towards the Capital City of Capitalcityton, due Space East of your position. \n\nThe walk is a long one, and made longer still by the nearly thirty minutes you spend applying war paint.  As you`re finishing the final line of reddened mud under your eyes and considering whether or not to shout a bestial roar, you hear the distinct whine of a hyper-jet engine.  A Spaceplane zooms by overhead and you hear the thudding of RoboTrons hitting the ground ahead of you.  Peering through the leaves you see four of them, what do you do?", "NULL", "NULL"},
      new String[] {"5", "With the pods, RoboTrons, and Duke behind you, Capitalcityton begins to stretch out to your front.  Despite being the largest city on the entire planet, you are able to enter it rather easily, soon finding yourself in the heart of the city.  The Professorial Mansion stands near the center as a testament to both Democracy and Science.  This is both the home of Freedom on Trapistan and the dwelling of Governor-Professor Notevil, a sprawling complex of unregulated research labs and self guided law-making.  However, the justice that this esteemed domicile stands for is marred by the RoboTrons.  Judging from the Bots patrolling around, the Professor is probably inside.  You have a few options..", "NULL", "NULL"},
      new String[] {"7", "You decide that you have to use techniques you learned in the Hypergreen Berets to remain in a state of constant readiness.  Standing inconspicuously at a street vendor peddling protein shakes, you begin your squat routine while keeping an eye on the mansion.  You only make it to four-thousand-twenty-seven before you spot movement.  A convoy of armored vehicles pull up to the front door of the mansion, and you spot the professor being moved down towards them. He is surrounded by RoboTrons.  Time is short, and the sooner this mission is over the sooner you can continue leg day.", "NULL", "NULL"},
      new String[] {"8", "The man inside looks up at you with a surprised expression. ``Governor-Professor Notevil, my name is &PlayerCharacter&, and I`m here to rescue you.  For Democracy.``  The automated light on your back projects a waving Space American flag on the surface behind you.  ``Oh thank science, you`re here! But please, call me Judas,`` He says with a warm smile and a wink, ``Professor Notevil is my father.`` Completely trusting this obviously friendly and allied person you go to open the door.  As your back is turned the Professor strikes.  Using his powers of Judo, he flips you out of the car, and into the waiting arms of the arrayed RoboTrons.", "NULL", "NULL"},
      new String[] {"9", "You slowly regain consciousness. Straining your impressive muscles against the steel restraints, you quickly take stock of the situation.  You are tied down to a chair in a plain, unadorned room.  Across from you is the only feature, a large television stretching across the entire wall.  A row of RoboTrons stands in front of the television, weapons at the ready.  The television flickers on, showing the smiling face of Governor-Professor Notevil.  ``Hello FIRSTNAME, I`m so glad you could join us.  I`d love to stay and chat but there are two other heroes I`m set to monologue to shortly.  So, tata!.``  He laughs effeminately as the screen flickers off, and the RoboTrons aim their weapons at you, and...\n\nTHE WALL EXPLODES\n\nRoboTrons scatter as the force of the explosion sends some flying.  Through the haze of debris that miraculously left you with only superficial, and attractive, damage, you can make out a group of people fighting their way through the RoboTrons.  But one of the Bots sets his sights on you, and is coming your way..", "ProfessorNotevil", "NULL"},
      new String[] {"10", "With the threat neutralized you take a look around.  The remaining RoboTrons have been eliminated by your rescuers.  A closer inspection reveals a ragtag group of misfits, fighting for liberty.  You are able to tell this by their motley assortment of gear, and general punk type attire. ``&PlayerCharacter&, we`re the Resistance.  We`re here to save you, and bring democratic voting back to Trapistan!``  Their energetic leader proclaims.  With a curt nod and some stoic pride in Space America, the lot of you proceed out through the newly exploded exit.\n\nThe rest of the escape follows much the same plan as the beginning.  Several offending walls are demolished, and there are plenty of firefights with the Bots.  You are fairly certain that there were some tearful goodbyes and sacrifices, but since they weren`t player characters or named NPCs you glossed over them.  Finally after a climactic battle in which you had to smash a RoboTron with a Diving Double Axe Handle, you come across a room marked `Hangar`.  You see a variety of vehicles: a few fliers, an armored personnel carrier, and a set of hover-cycles.  Striding past the practical but unsexy armored vehicles and the unfairly effective air skimmers, you jump into the thematically much cooler hover-cycles and take to the sky-streets.", "NULL", "NULL"},
      new String[] {"11", "You and the Resistance fighters scramble into three hover-cycles and punch it out of the hanger.  The vehicles clear the bay and scream out into Capitalcityton proper.  Lines of RoboTrons fire ineffectually at your group as you zip off towards freedom... and revenge.  The wind whips through your tousled hair as you turn in your seat and spot the next threat to freedom.  Barrelling down the avenue towards you is one of Trapistan`s greatest weapons: a Mechaspider. The fearsome vehicle crashes along main street, its legs crushing cars, smashing through buildings, and generally causing extreme and mostly unnecessary property damage. \n\nHow do you respond?", "Mechaspider", "NULL"},
      new String[] {"12", "With a final creaking, mechanical sigh the Mechaspider collapses to the ground, andn the distance you can hear the sounds of RoboTrons making their way towards the scene of battle.  The Resistance fighters are fist pumping, high fiving, and otherwise generally celebrating this victory over tyranny, evil, and Notevil.  Casting your gaze over the scene you realize that you have a choice to make.  You can either stay and salvage whatever useful materials might be left in the Mechaspider, or you can regroup with the Resistance and get to freeing Trapistan from its oppressors.", "NULL", "NULL"},
      new String[] {"13", "The hover-cycles hum as they descend through the Resistance HQ roof hatch.  As you land you are greeted by a haggard looking man in a torn military jacket. ``Star Major, you have no idea how much of a relief it is to see Macho Squad here.`` \n\nYou are ushered through winding hallways.  The building itself is run down, little more than a disused warehouse, but everywhere are stacked munitions, vehicles, and armed registered voters. ``It`s been two weeks since the local newspaper, voice of the people, ran a story about Governor-Professor Notevil.  It would seem that his Stellar Birth Certificate was forged.  Judas wasn`t even born in Space America.  He`s from Space Canada.``  You nod knowingly. Space Canada has long since been a breeding ground for un-American ideas like environmental protection and drum circles.  \n\n``Not long after that came to light he flooded the streets with his RoboTrons, shutting down anybody who resisted.  We`ve been trying to take him out for days, but he`s locked himself away in that mansion, and the only way to override those locks is by curling 400lbs.``  You look forlornly at the ground before replying.  ``The only man I know who could curl 400lbs is dead.  Duke Ramierez went down with the rest of my squad.``", "NULL", "NULL"},
      ...
      new String[] {"15", "You feel good about your progress. Maybe if you can better yourself you can better Trapistan, and Space America too.  You`re pulled out of thought by the Resistance leader.  ``Star Major, we have a plan.  The Professor is plotting to kill Democracy across the Space Nation.  Now that we can get into his Professorial Mansion we can put a stop to it.  But first we`ll have to draw out his elite Skull Battalion.  We`ve been working on a couple of options...``", "NULL", "NULL"},
      new String[] {"16", "The Skull Battalion has been drawn out.  Your display was enough to draw their full ire, and the time has come to end this.  Governor-Professor Notevil has been working against Space America, against Democracy, and it's Macho Squad`s job to take him out.  Using back roads and secret tunnels, you position yourself near the Professorial Mansion.  Even with the Skull Battalion gone the place is locked down tight, and you`ll have to decide how you`re going to assault it.", "NULL", "NULL"},
      new String[] {"17", "Readying your hover-cycle you activate your communicatron.  ``Alright everyone, we have one job: stop Governor-Professor Notevil.  Begin the assault.`` Resistance troops pour out from the surrounding buildings, starting the attack in earnest.", "NULL", "NULL"},
      new String[] {"18", "The front doors of the Professorial Mansion stretch above you as you get into position.  On your word the assault begins, with Resistance forces hitting the building from all sides.  You and Duke lock forearms again in a display of raw manliness.  No more running, no more hiding.  Now it was time to enforce Democracy.", "NULL", "NULL"},
      new String[] {"19", "Duke walks up to the locking mechanism, eyes the curling bar and smirks.  As he holds the door open you enter the building, a small team of Resistance eggheads in tow, Duke bringing up the rear.  Security inside is light, they didn`t expect Macho Squad or the raw curling power of Duke Ramierez.  You make your way to the command and control room, dispatching the guards with ease.  Your hacker pushes his small rimmed glasses up his face, sits down, cracks his knuckles and gets to work.  \n\n``All I have to do is brute force the back door, reverse the polarity of the code buffer and..  There, complete control.``  The furious typing dies down as he enters one final command.  ``I`ve set the curl weight on the door controls to 1lbs.  Governor-Professor Notevil is about to have a real bad day.``  He says as he lights up a cigarette, and you see a tide of people surging towards the Mansion on the monitors.", "HackTheButton", "NULL"},
      new String[] {"20", "You see Governor-Professor Notevil stealthily duck through an open doorway, and you bolt into hot pursuit.  His RoboTrons guards try to stop you but are thwarted by the arrival of angry citizens, which is both timely and implausible.  Ignoring the melee you charge headfirst after your foe.  Just as you round a corner you catch sight of him heading towards a large set of blast doors labled \"Reactor Control\".", "NULL", "NULL"},
      new String[] {"21", "Governor-Professor Notevil glances back from the sealed door towards you, his back still turned.  \"I should’ve known you’d find a way to turn the Registered Voters against me….  But no matter.  Soon you won’t be around to stop ANY villainous characters!\"  With a flourish Judas whirls around, his Mayoral Cape flying to the ground, and reveals a pair of Quantum Nunchucks gripped in his hands.  Governor-Professor Notevil stares hatred towards you, a dare to engage him in an impractical but undeniably cool nunchuck fight.  You briefly consider shooting him in the chest, but no, to truly show your superiority you must defeat him in single combat.  For Space America. ", "NULL", "NULL"},
      new String[] {"22", "The fight is done and Governor-Professor Notevil is subdued, but you get a feeling that this isn’t over.  Maybe it’s the red emergency lighting that has flipped on, or maybe it’s the Professor’s cackling and statement that \"This isn’t over….\".  Duke Ramierez rushes up behind you, the nerds in tow.  \"&PlayerCharacter&!  The Professor has set the planet’s Solar Power Plant to overload!  We have less than two minutes to get out of here!\"  Looking to your side you see the Escape Craft Hangar, while in front of you sits the now sealed door to the Reactor Control….", "NULL", "NULL"}
    };
    // END node details
    ...
    public static final String [][] popupDetails = new String[][] {
      ...
      new String[] {"3", "You steady the Megalaser 3,000 against a nearby branch, letting the capacitors build to full charge as you move the scope reticule towards the enemy.  One of the RoboTrons starts to look quizzically at the initial target laser upon his chest, right before you let loose a burst.  As the first hostile hit the ground the others whirled about, trying to locate their attacker.  The bright red bolts struck too fast for them to react however, proving once again that nothing can stop a Space American armed with the greatest weapons Space America can buy from Space Belgium.", "RoboBodies", "NULL", "-1", "-1"},
      new String[] {"4", "The RoboTrons aren`t the most observant enemy you`ve ever faced.  Even the Quasar Qommunists pay more attention as they search an area.  As their patrol approached your location, you let out a battle cry and charged.  `DEMOCRACY!!!`  You scream as you grab the first RoboTron by the wrists, and swing him like a giant club into the others.  Hydraulics, gears, and blinking lights of questionable usefulness fly in all directions as you beat the patrol, with the patrol until the only thing moving in the area is a registered voter.", "RoboBodies", "NULL", "-1", "-1"},
      new String[] {"5", "You wait while the patrol moves closer and closer to your position.  As one of the soldiers gets particularly close you grab its arm and try to pull it into the trees with you.  However you get the feeling that the RoboTron is far heavier and stronger than you`d anticipated as you flew through the air, colliding another RoboTron.  \n\nThinking quickly you switch to Antimatter Cobra Style, and land a series of blows no generic, nameless foe could withstand.  In short order you find yourself alone in the field, with a reminder that the RoboTrons are dangerous", "RoboBodies", "NULL", "3", "-1"},
      new String[] {"6", "As much as ridding Trapistan, and the Galaxy of a few RoboTrons would help Space America, you have a mission.  Saving Governor-Professor Notevil quickly means that these Bots get a pardon.  For today.  Using all of the training you got in Space Commando Camp, you throw a rock at a in another direction and watch as they search in its vicinity for the next ten to forty-five minutes.", "NULL", "NULL", "-1", "-1"},
      new String[] {"7", "The RoboTrons are a blight on the galaxy, but one that will have to wait.  You`ve got a mission to do.  Summoning all of your strength, skill, and raw aptitude you duck under the tree branches and sprint past the RoboTrons while their backs are turned.  However you find yourself distracted naming all of the Space States and their Space Capitals, not noticing the dry branch until your foot falls on top of it.  Their knock-off Inferiorlaser 1,500s still smart as they burn through your standard issue Tank Top.  Thinking fast you plant your foot on a nearby log and push off, jumping through the air and over a nearby fence.  With some breathing room you are easily able to outpace the RoboTrons.", "NULL", "NULL", "3", "-1"},
      new String[] {"8", "While a lesser man may sit and catalog such routes for hours, you have neither the time nor the cowardice to sit and wait.  When you are certain of an opening in the patrols after six minutes of observation, you get to work, an intricate plan taking form.  \n\nWhile their backs are turned you sprint up to the door and pull on the handle.  However, the door does not open despite your herculean strength.  To the side of the door you notice a horizontal bar at waist height.  Diving into your memory you recall three minutes prior when a RoboTron had curled it, resulting in the door opening.  As you strain against the unmoving object a nearby RoboTron slowly turns back around.  Seeing you struggling to open the door it raises its Inferiorlaser 1,500 and burns a hole in your skin-tight, unarmored tank top.  Abandoning the bar you seize the RoboTron, and throw him across the street, following up with an elbow drop to finish it.  You find yourself right back where you`d started..", "NULL", "NULL", "3", "-1"},
      new String[] {"9", "It`s probably going to be a long wait, you`ll need to find something to occupy your time.", "NULL", "NULL", "-1", "-1"},
      new String[] {"10", "The Professor is being slowly loaded into the vehicle as you concoct a scheme so diabolical that it borders on Qommunist.  With some cardboard taken from a passing salesman and arts and crafts supplies appropriated from a nearby school bus you have everything you need.  In only a few minutes you have completed a simple sign stating `RoboTrons Detour`, complete with macaroni pasted around it for added authenticity.  With the trap set you need only wait in the indicated alleyway.  It doesn`t take long for the convoy to pull in.  Using all of your cunning and skill you drop down from the fire escape above the Professor`s vehicle, crashing through the roof and finding yourself alone with him.", "NULL", "NULL", "-1", "-1"},
      new String[] {"11", "Seeing the Professor being loaded into the convoy you spring into action.  Paint from the store behind you, boxes from behind the shipping company across the street, and twine from the purse of that kind old lady..  In no time flat your disguise is complete, even your own mother, may she rest in Space Heaven, would swear that you were a filthy Bots.  You stride up to the convoy stating ``Beep, Br1an told me to come here and do evil things.``  The RoboTrons were buying it, but only too late do you remember that RoboTrons pronounced it EVIL.  \n\nThe nearest RoboTron struck first with its Hydroelectric Stun Pulse, knocking you off of your feet.  You sprang back up, shedding the painted cardboard boxes which had provided your cover.  With a shout of ``LIBERTY!`` you charge forward, delivering a double-clothesline to the waiting RoboTrons, then ducking into the main vehicle.", "NULL", "NULL", "4", "-1"},
      new String[] {"12", "The RoboTrons are keeping close watch on the convoy, so this will require a delicate touch.  You wait for them to load the Professor into the middle vehicle, and start heading your way down the street.  As they get closer and closer you flex, preparing for the most devious operation of your storied career.  When the lead car got within 20 yards you sprung into action.  Hefting the protein shake cart above your head, you throw it towards the convoy.  With the lead vehicle and most of the guards incapacitated it is a simple matter of cross-chopping the last RoboTron, ripping the door off the middle vehicle, and climbing in to save the Professor.", "NULL", "NULL", "-1", "-1"},
      new String[] {"13", "Plan after plan rockets through your head.  Training is great, but it can never prepare you for being out in the field.  The medicine ball those kids down the street are playing with could be useful, but from the way they`re throwing it around it`s probably only 80lbs.  In the park nearby are some men playing polo, but damnit this is time for combat, not namby pamby Space European games.  That`s when you spot it.  Down the street a few dozen yards, some people playing True Football.  The ball is set up for kickoff, lined up perfectly with the Professorial mansion.  The convoy is pulling away, theres no time to wait.  Why. WHY did it have to be on Leg Day!?!  Gritting your teeth you push forward for the Professor, for Space America.  \n\nPushing the players out of the way you charge in, feeling the muscles in your calves pulling.  You grit your teeth and kick.  The ball flies true, striking the driver of the Professor`s vehicle and sending it careening into a nearby building.  Saying a quick thank you to George Blanda you charge forward, hopping into the car.", "NULL", "NULL", "4", "-1"},
      new String[] {"14", "The RoboTrons loaded the Professor into the back of the middle vehicle, and started filing into their own.  Seeing that time was short, you stride up to the RoboTron standing outside the Professor`s vehicle.  Looking over the Robotic minion`s chassis you note an important symbol.  `Hey buddy, I need to talk to the man` you say, motioning towards the vehicle.  The guard is understandably wary, until you reveal the hastily scrawled drawing you put on your arm.  `Bro!  I`m from Robot Epsilon Tau Binary!`  The string of freshly drawn Binary glistens in the morning sun, and you can see the machine eyes of the RoboTron soften as he reveals his own.  There is a short exchange of fairly awkward small-talk before he ushers you into the vehicle.", "NULL", "NULL", "-1", "-1"},
      new String[] {"15", "You saunter up to the RoboTron who is ushering the Professor into the car.  `Hey, fellow Robotic soldier, the Command Unit has sent me to interrogate the prisoner.`  You can see the literal gears turning within its head as it considers what you`ve said, and your distinct lack of robotic exoskeleton.  After a few short moments, the RoboTron raises its Inferiorlaser 1,500 and fires a shot into your side.  Abandoning the facade you grab the RoboTron by the wrists and swing it wide around, dashing it against the vehicle.  Wasting no time you jump into the door, moving in to rescue your target.", "NULL", "NULL", "4", "-1"},
      ...
      new String[] {"17", "Blowing up a wall, a clever distraction.  The restraints binding you to the chair may be steel, but something like tensile material strength and human limits never stopped Macho Squad in the past.  Not when Space America needs you.  Screaming your rage you pull with all your strength.  The restraints tear free and you seize the chair, throwing it at the offending Bots.  It strikes it in the chest, scattering pieces of robot, Inferiorlaser 1,500, and justices around the room.", "RoboBodies", "NULL", "-1", "-1"},
      new String[] {"18", "This is not how Macho Squad dies.  You clear the haze from your mind and focus on freeing yourself from the chair.  Straining with all of your might you can hear the metal start to strain and twist before you.  Your reverie is broken as the Bots fires his weapon, the laser cutting into your shoulder.  Only a flesh wound.  WIth the pain feeding your rage you are able to summon the last few PSI required.  The restraints go flying across the room as you leap into a charge, tackling the RoboTron that had shot you.  Fists of fury pound the offending automaton into unrecognizable pieces.", "NULL", "NULL", "3", "1"},
      new String[] {"19", "No shackles can keep Macho Squad down for long.  You strain against the steel, hearing the metal begin to give way.  But you have no time, the RoboTron in front of you starts to raise its weapon.  Thinking quickly you call out to the people who are currently attacking the Bots.  One of them turns, catching sight of the enemy taking aim at you and the American Flag Bandana around your head.  The man dives between the threat and you as the RoboTron fires his Inferiorlaser 1,500.  The patriot falls like only an unnamed non-player character can, a single tear shedding from his eye and his arm raising in a salute to the flag.  His sacrifice will be memorialized with your victory.  \n\nWith a scream of rage you tear free of the chair, hurling it at the Bots.  The chair catches it in the upper arm, throwing it off balance as you follow up with a full body tackle.", "NULL", "NULL", "-1", "-1"},
      ...
      new String[] {"34", "Quickly analyzing the situation you direct the Resistance fighters to attack all of the entrances.  Meanwhile Duke and you would strike the front door.  They`d never see it coming.", "NULL", "NULL", "-1", "-1"},
      ...
      new String[] {"36", "You gun the hover-cycle, coming in low over the hoverpad.  A squad of Bots line up to fire, but don`t see Duke coming in from behind.  He smashes into the back of their line, grabbing one Bots in each hand and wielding them like nunchucks.  You line up your weapon, picking off the remaining hostiles with ease.", "NULL", "NULL", "-1", "-1"},
      new String[] {"37", "The hover-cycle roars as you rush through the air up towards the hoverpad, however your way is barred.  A group of RoboTrons block the way.  You start evasive maneuvers, barrel rolling your way through arcs of Inferiorlaser 1,500 fire.  But you`re not quite fast enough.  Their barrage melts the control column of the bike, sending you careening down into the pad.  Luckily you walk away from the crash with little more than a few scratches and superficial wounds.  Nothing that stops you from tearing apart the remaining Bots.", "NULL", "NULL", "4", "-1"},
      new String[] {"38", "You zoom up towards the hoverpad, the hover-cycle humming between your legs.  As you crest the edge you bring it down skillfully and quickly onto the pad.  The waiting squad of RoboTrons turn towards you and start advancing, weapons drawn.  You can`t help but smile as you heft the hover-cycle above your head, arms glistening in the sunlight.  The bike sails through the air, crashing into the squad and smashing them to pieces.", "NULL", "NULL", "-1", "-1"},
      new String[] {"39", "You fly the hover-cycle down towards the waiting hoverpad.  A squad of RoboTrons waiting for you as you sail down from the sun.  Winding up, you throw the object in your hand towards the first of the Bots.  The baseball catches it in the head, and it crumples to the ground incapacitated.  You have little time to celebrate as the others open fire, sending your vehicle crashing down to the pad.  You pull yourself from the wreckage as you see Duke come up from the other side, descending on the unwary Bots like a predatory bird.", "NULL", "NULL", "4", "-1"},
      new String[] {"40", "You rush up towards the front door, which is flanked by several RoboTrons.  They turn to face you, trying desperately to respond in time to prevent your vicious assault.  They fail.  One after the other the Bots fall to your blows, till you are left with the final, terrified foe.  You walk up to it and deliver the last shot.  A literally Bionic Elbow drives it down to the ground, and leaves you and Duke alone to enter the Mansion.", "NULL", "NULL", "-1", "-1"},
      new String[] {"41", "A squad of Bots are covering the front door as you approach.  Grabbing a nearby fruit stand, you start wheeling it towards the enemy to provide yourself with cover.  Their Inferiorlasers hum with power as the beams cut into your barricade, and eventually into you.  But it serves well enough, allowing you to close the distance and engage them in honorable hand-to-hand combat.  Up close the Bots stand no chance, falling quickly to the Saluting Eagle Style.", "NULL", "NULL", "5", "-1"},
      new String[] {"42", "The front door is guarded by a team of RoboTrons, but thats just fine.  You prepared for this.  Grabbing the waiting Resistance member by the wrists you mimic Duke, swinging the man around and tossing him through the air towards the enemy.  Soaring Eagle Style.  It works every time.  With the distance closed you and your team make quick work of the guards, leaving you ready to enter the Mansion.", "NULL", "NULL", "-1", "-1"},
      new String[] {"43", "You spend some time concocting a brilliant plan.  Directing a squad of Resistance troopers to the other side of the street, you instruct them to attack while you distract the Bots.  Stepping free from the cover you execute your brilliant plan to draw their attention.  `Facism is dumb!` you yell.  The Bots immediately open fire, striking you several times before the Resistance fighters are able to quell them.  Your plan seems to have worked too well.", "NULL", "NULL", "5", "-1"},
      ...
      new String[] {"49", "You reach to your belt, and draw your own Quantum Nunchucks just in time to deflect his first attack.  Sparks, curses, and dimensional anomalies fly in all directions as the weapons strike each other.  Judas is skilled, but he’s not the leader of Macho Squad.  After an initial couple of harrowing strikes you come back stronger than before, and send his weapons flying to the ground.", "NULL", "NULL", "-1", "-1"},
      new String[] {"50", "As you lower your weapon and reach for the Quantum Nunchucks on your belt Judas strikes out, catching you across the chin.  Your life flashes before your eyes, a slideshow of success after success.  Graduating first in your Platoon at Kindergarten.  Catching 800 game winning touchdowns.  Signing up for the Space Army at 16.5.  But this is how it ends.  Everything going dark because you were too slow.", "NULL", "NULL", "100", "-1"},
