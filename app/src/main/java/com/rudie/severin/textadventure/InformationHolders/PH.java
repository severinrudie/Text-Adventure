...
//    public static final String POPUP_ID = "POPUP_ID";   // used to send popupId to a fragment
    ...
    public static final String [][] nodeDetails = new String[][] {
        ...
        new String[] {"10", "With the threat neutralized you take a look around.  The remaining &BadMinionPlural& have been eliminated by your rescuers.  A closer inspection reveals that they appear to be a ragtag group of misfits, fighting for liberty.  You are able to tell this by their motley assortment of gear, and general punk type attire.\"&PlayerCharacter&, we're the Resistance.  We're here to save you, and bring democratic voting back to Trapistan!\"  Their energetic leader proclaims.  With a curt nod and some stoic pride in Space America, the lot of you proceed out through the newly erected exit hole.\n\nThe rest of the escape follows much the same plan as the beginning.  Several offending walls are demolished, and there are plenty of firefights with the &BadMinionSlang&.  You are fairly certain that there were some tearful goodbyes and sacrifices, but since they weren't player characters or named NPCs you glossed over them.  Finally after a climactic battle in which you had to smash a &BadMinionSlang& with a Diving Double Axe Handle you come across a room marked \"Hangar\".  In the hangar you see a variety of vehicles, a few fliers, an armored personnel carrier, and a set of hover-cycles.  Striding past the heavily armored vehicles, and fast air skimmers you jump into the thematically cool hover-cycles and take to the sky-streets.", "NULL", "NULL"},
        new String[] {"11", "You and the Resistance fighters scramble into three hover-cycles and punch it out into the street.  The vehicles clear the hangar and scream out into Capitalcityton proper.  Lines of &BadMinionPlural& fire ineffectualy at you and your rescuers as you zip through the streets and off towards freedom.  The wind whips through your flowing hair as you turn around in your seat, and get a good view of the next threat to freedom.  Barrelling down the main street towards you is one of Trapistan's greatest weapons.  A Mechaspider is crashing down main street towards you and the fleeing Resistance members.  Its legs crushing cars, smashing through buildings, and generally causing extreme and unnecessary property damage. \n\nHow do you respond?", "Mechaspider", "NULL"},
        new String[] {"12", "With a final creaking, mechanical sigh the Mechaspider collapses to the ground.  In the distance you can hear the sounds of &BadMinionPlural& making their way towards the scene of battle.  The Resistance fighters are fist pumping, high fiving, and otherwise generally celebrating this victory over tyranny, evil, and Notevil.  Casting your gaze over the scene you realize that you have a choice to make.  You can either stay and salvage whatever useful materials might be left in the Mechaspider, or you can regroup with the Resistance and get to freeing Trapistan from its oppressors.", "NULL", "NULL"},
        new String[] {"13", "The hover-cycles hum as they descend through the roof hatch of the Resistance HQ.  As it settles to the ground you are greeted by a haggard looking man in a torn military jacket.  \"Star Major, you have no idea how much of a relief it is to see Macho Squad here.  You are ushered through the hallways.  The building itself is run down, little more than a disused warehouse, but everywhere are stacked munitions, vehicles, and armed registered voters.  \"It's been two weeks since the local newspaper, voice of the people, ran a story about &ProfessorFullTitle&.  It would seem that his Stellar Birth Certificate was forged.  &ProfessorNameShort& wasn't even born in Space America.  He's from Space Canada.\"  You nod knowingly, Space Canada has long since been a breeding ground for un-American ideals like environmental protection and non-interventionism.  \"Not long after that came to light he flooded the streets with his &BadMinionPlural&, shutting down anybody who resisted.  We've been trying to take him out for days, but he's locked himself away in that mansion.  The only way to override those locks is by curling 400lbs.\"  You look forlornly at the ground before replying.  \"The only man I know who could curl 400lbs is dead.  &BuddyFullName& went down with the rest of my squad.", "NULL", "NULL"},
        new String[] {"14", "The Resistance leader gives you a final nod.  \"We're working on a final plan, but we need some time.  Just enough time for a Macho Squad training routine.  He guides you to the HQ building's gymnasium, and lets you get to work..", "NULL", "NULL"},
        new String[] {"15", "You feel good about your progress, as if maybe if you can better yourself then you can better Trapistan, and Space America.  Your reverie is broken by the Resistance leader.  \"Star Major, we have a plan.  &ProfessorTitleShort& has a plan to kill Democracy across the Space Nation.  Now that we can get into his Professorial Mansion we can put a stop to it.  But first we'll have to draw out his elite Skull Battalion.  We've been working on a couple of options..\"", "NULL", "NULL"},
        new String[] {"16", "The Skull Battalion has been drawn out.  Your display was enough to draw their full ire.  Now was the time to end this.  &ProfessorFullTitle& has been working against Space America, against Democracy.  It was up to Macho Squad to end him.  Using back roads, and secret tunnels you position yourself near the Professorial Mansion.  Even with the Skull Battalion gone, the place is locked down tight.  You'll have to decide how you're going to assault it.", "NULL", "NULL"},
        ...
        new String[] {"18", "The front doors of the Professorial Mansion stretch above you as you get into position.  On your word the assault begins, with Resistance forces hitting the Mansion from all sides.  You and &BuddyNickname& lock forearms again in a display of raw manliness.  No more running, no more hiding.  Now it was time to enforce Democracy.", "NULL", "NULL"},
        new String[] {"19", "&BuddyNickname& walks up to the locking mechanism, eyes the curling bar and smirks.  As he holds the door open you enter the building, a small team of Resistance eggheads in tow, &BuddyNickname& bringing up the rear.  Security inside is light, they didn't expect Macho Squad or the raw curling power of &BuddyFullName&.  You make your way to the command and control room, dispatching the guards with ease.  Your hacker pushes his small rimmed glasses up his face, sits down, cracks his knuckles and gets to work.  \"All I have to do is brute force the back door, reverse the polarity of the code buffer and..  There, complete control.\"  The furious typing dies down as he enters one final command.  \"I've set the curl weight on the door controls to 1lbs.  &ProfessorFullTitle& is about to have a real bad day.\"  He says as he lights up a cigarette, and you see a tide of people surging towards the Mansion via the monitors.", "HackTheButton", "NULL"},
...
public static final ChoiceData [] choiceDetails = new ChoiceData[]{
    ...
    public static final String [][] popupDetails = new String[][] {
        ...
        new String[] {"35", "You drop down low and move towards the sewers entrance.  You pry up the grating, staring into the dank abyss as it occurs to you.  You're Macho Squad.  Democracy won't be saved by sneaking, now was the time for action.  Wreckless, unnecessary action.", "NULL", "NULL", "-1", "-1"},
